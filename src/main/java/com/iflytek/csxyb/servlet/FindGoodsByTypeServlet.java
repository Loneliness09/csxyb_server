...
@WebServlet(name = "FindGoodsByTypeServlet", value = "/FindGoodsByTypeServlet")
public class FindGoodsByTypeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (user == null) {
            ...
            List<Goods> goodsList = goodsService.findGoodsByNameAndType(user, name, type, pageNum, pageSize);
